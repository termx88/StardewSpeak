...
mapping = {
    ...
    "ore (clear | mine)": objective.objective_action(objective.ClearOreObjective),
    ...
    "crafting gather": objective.function_objective(game.gather_crafted_items),
    "forage": objective.function_objective(game.gather_forage_items),
    "(objects | items) gather": objective.function_objective(game.gather_objects),
